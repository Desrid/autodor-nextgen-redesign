...
## Official emblem SVGs from public sources

These two footer additions were requested after the approved Figma export. They use intact public SVG emblems rather than reconstructed or traced artwork. The linked destinations are the agencies' official websites.

| Purpose                    | Repository file                     | Source and verification                                                                                                                                                                                                                                                                         | Size                         | SHA-256                                                            | Status                                                 |
| -------------------------- | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------ |
| Rostransnadzor emblem      | `public/brand/rostransnadzor.svg`   | [Wikimedia Commons source SVG](https://commons.wikimedia.org/wiki/File:Emblem_of_the_Federal_Service_for_Supervision_of_Transport.svg); identity verified against [Rostransnadzor official symbolism](https://rostransnadzor.gov.ru/rostransnadzor/about/ofitsial-naya-simvolika-rostransnadzo) | `713 x 799`, `177,510` bytes | `ccb69aa58bdea0f2809eec4fc0abd876652692ed32fda855be28199b02194a2f` | Intact SVG; official insignia; footer link addition    |
| President of Russia emblem | `public/brand/president-russia.svg` | [Wikimedia Commons source SVG](https://commons.wikimedia.org/wiki/File:Emblem_of_the_President_of_Russia.svg), attributed there to `kremlin.ru`; destination and identity verified against the [official President of Russia website](https://kremlin.ru/)                                      | `324 x 360`, `50,628` bytes  | `659850a018167f5643d13f9e21638f3732bab1b4652fb94b100143635afb6ec7` | Intact SVG; CC BY 4.0 attribution retained in registry |
| Gosuslugi compact logo     | `public/brand/gosuslugi.svg`, `public/brand/gosuslugi-compact.png` | User-provided compact-logo reference (2026-08-11); the PNG is used intact in a transparent SVG wrapper so the requested artwork, lettering and proportions are not re-drawn. | `304 x 214`, PNG inside SVG wrapper | SVG: `f0e590d436a2b9db568e8d18a3c98a400cb8085c8d9a6c517091724cd6a30258`; PNG: `210f8ab123998acfb97208c91f38846e525c0b318e8962077e7e8a8c822bb87a` | Footer link addition; black canvas made transparent only |

...
| Header E2E            | Тексты и порядок Figma, state contract, focus, keyboard, 44 px, overflow, axe, reduced motion, desktop/tablet/mobile visual states | `npx playwright test e2e/header.spec.ts`                               |
...
| --: | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------- | -------------- |
| R01 | `1767:4878`, `1767:4879`, `1767:5397`, `1767:5923`, `1767:6576` | Header, точная closed/mega композиция, единый IA, keyboard/state/focus contract               | `header.spec.ts`; `requirements: R01`; unit component/data                | Ручное сравнение closed/mega/search и mobile open завершено | AUTO PASS      |
...
| R04 | `1767:7270`                                                     | Заголовок над rail, controls справа, 3 карточки на desktop; факты без размножения одной акции | `LoyaltyRail.client.test.tsx`; `loyalty.spec.ts`; `requirements: R04-R07` | loading/error/retry, keyboard/swipe, responsive rail        | AUTO PASS      |
...
| R09 | `1767:7415`                                                     | Ряды `A4:B7`/`I4:J8`, derived total/доли, donut и две видимые таблицы-эквиваленты             | `statistics.test.ts`; `StatisticsBlock.test.tsx`; `requirements: R09-R10` | tooltip keyboard/SR, responsive 3→2→1, chart not color-only | AUTO PASS      |
